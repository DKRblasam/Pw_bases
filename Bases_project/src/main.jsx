...
content.render(
  ...
  <Card title={'G01 Interpolacion circular a derechas'} 
  descrip={'Los movimientos programados a continuacion de G02 se ejecutan en forma de trayectoria circular al avance de F programado. La interpolacion circular solo se puede ejecutar en el plano'} 
  format={'G01 X+/-5.3 Y+/-5.3 Z+/-5.3'} img={'/public/G00.webp'} 
  notes={'El codigo G01 es modal e incompatible con G00,G02,G03,G33.'}/>

<Card title={'G02 Interpolacion Lineal'} 
